@extends('admin')
@section('blog', 'active')
@section('title', 'Tất cả tin')

@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-rss"></i> Tất cả tin </h1>
            </div>
            <a href="{{route('admin.blog.add')}}"> <button type="button"  class="btn btn-info"><i class="fa fa-plus"></i> Thêm tin</button> </a>
                ...
                <table class="table table-hover">
                    ...
                    @foreach($blog as $data)
                        <tr>
                            ...
                            <td>{{$data->title}}</td>
                            <td>
                                @if($data->status == 1) <span class="badge badge-success">hiện</span>
                                @else <span class="badge badge-danger">ẩn</span>
                                @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Bạn có chắc muốn xóa tin này?</h5>
