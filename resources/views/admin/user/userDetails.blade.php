                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-primary btn-block" href="{{route('admin.transaction.report', $data->id)}}"> In giao dịch<br></a>
                            </div>
                        </div>
                        <br>
                ...
                <form action="{{route('admin.userDetails.update')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="checkbox" name="user_banned" @if($data->user_banned == 0) checked @endif
                            data-toggle="toggle" data-on="Hoạt động" data-off="Banned" data-onstyle="success" data-offstyle="danger" data-width="100%">
                        </div>
                    </div>
