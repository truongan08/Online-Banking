                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <fieldset>
                                        ...
                                        <input class="form-control"  value="{{ Auth::user()->email }}" placeholder="Chỉ được đọc" readonly="">
                                    </fieldset>
                                </div>
                                <div class="form-group col-md-12">
                                    <fieldset>
                                        <label class="control-label" for="readOnlyInput">@lang('Username')</label>
                                        <input class="form-control"  value="{{ Auth::user()->username }}" placeholder="Chỉ được đọc" readonly="">
                                    </fieldset>
                                </div> <div class="form-group col-md-12">
                                    <fieldset>
                                        <label class="control-label" for="readOnlyInput">@lang('Account Number')</label>
                                        <input class="form-control"  value="{{ Auth::user()->account_number}}" placeholder="Chỉ được đọc" readonly="">
                                    </fieldset>
                                </div>
