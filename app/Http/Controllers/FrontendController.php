...
class FrontendController extends Controller
{
    ...
    public function registrationFrom()
    {
        ...
        if ($registration == 1 )
            ...
            return redirect()->route('homePage')->withErrors(['Đăng kí tạm thời tắt']);
    }
    ...
    public function subscribePost(Request $request)
    {
        ...
        if ($email == NULL)
        {
            ...
            $data->save();
            return redirect()->back()->with('success', 'Cám ơn vì đã đăng kí');

        }else{

            return redirect()->back()->withErrors(['Email đã đăng kí']);
        }
